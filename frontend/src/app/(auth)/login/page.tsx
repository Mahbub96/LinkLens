...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 bg-surface-0 relative overflow-hidden">
      {/* Background */}
      <div className="absolute top-1/4 left-1/3 w-80 h-80 bg-brand-500/10 rounded-full blur-3xl" />
      <div className="absolute bottom-1/4 right-1/3 w-60 h-60 bg-purple-500/10 rounded-full blur-3xl" />
